...
<div class="dashboard-wrapper">
    <div class="admin-card">
        <div class="admin-card__header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h4 class="mb-1" style="color: var(--admin-text);">Tambah Siswa</h4>
                <p class="mb-0" style="color: var(--admin-text-muted);">Input data siswa baru ke sekolah terpilih.</p>
            </div>
        ...
        <div class="admin-card__body">
            ...
            <form action="{{ route('admin.students.store') }}" method="POST">
                ...
                <div class="mt-4 d-flex flex-wrap gap-2">
                    <button type="submit" class="admin-btn admin-btn--solid">Simpan Siswa</button>
